...
// Obtener información del usuario actual - SIN DEFAULT A 1
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_url_id'])) {
    ...
    try {
        ...
        if ($is_superadmin) {  // SOLO EL SUPERADMIN puede eliminar cualquier URL
            ...
            // Todos los demás (incluidos admins) solo pueden eliminar sus propias URLs
    ...
    <div class="container">
        ...
        <nav class="sidebar" id="sidebar">
            ...
            <div class="nav-menu">
                ...
                <a href="?section=urls" class="nav-item <?php echo $section === 'urls' ? 'active' : ''; ?>">
                    <span class="nav-icon">🔗</span> <?php echo $is_superadmin ? 'Todas las URLs' : 'Mis URLs'; ?>
                </a>
        ...
        <main class="main-content">
            <div class="dashboard-header">
                <h1>
                    ...
                    switch($section) {
                        ...
                        case 'urls': echo '🔗 ' . ($is_superadmin ? 'Todas las URLs' : 'Mis URLs'); break;
            ...
            <?php if ($section === 'dashboard'): ?>
                <?php
                // Obtener estadísticas - MODIFICADO PARA QUE ADMINS SOLO VEAN SUS DATOS
                try {
                    if ($is_superadmin) {
                        // Solo el superadmin ve estadísticas globales
                ...
                <div class="stats-grid">
                    <div class="stat-card">
                        ...
                        <div class="stat-label"><?php echo $is_superadmin ? 'URLs Totales' : 'Mis URLs'; ?></div>
                        <?php if ($today_urls > 0): ?>
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-label"><?php echo $is_superadmin ? 'Clicks Totales' : 'Mis Clicks'; ?></div>
                ...
                <div class="data-table">
                    ...
                    try {
                        if ($is_superadmin) {
                            // Solo el superadmin ve todas las URLs
                            $stmt = $db->query("
                            ...
                            // Admins y usuarios solo ven SUS URLs
                            $stmt = $db->prepare("
                                SELECT u.*, cd.domain as custom_domain 
                                FROM urls u 
                                LEFT JOIN custom_domains cd ON u.domain_id = cd.id 
